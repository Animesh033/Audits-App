...
class RegionController extends Controller
{
    ...
    public function regionDetails(Request $request){
      ...
      $regions = Region::where('name', $request->regionName)->select('id','name', 'state_id', 'city_id')->orderBy('name')->get();
        return view('admin.regions.regionPage', compact('regions'));
    }
}
